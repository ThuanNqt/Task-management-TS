...
const changeMulti = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        switch (objectChangeMulti.key) {
            case Key.STATUS:
                yield task_model_1.default.updateMany({ _id: { $in: objectChangeMulti.ids } }, { status: objectChangeMulti.value });
                break;
            case Key.DELETE:
                yield task_model_1.default.updateMany({ _id: { $in: objectChangeMulti.ids } }, { deleted: true });
                break;
        }
        res.json({
            code: 200,
